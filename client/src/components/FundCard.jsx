...
const FundCard = ({ owner, title, description, target, deadline, amountCollected, image, handleClick,category }) => {
  ...
  return (
    <div className={`sm:w-[288px] w-full ${isDark ? 'shadow-lg shadow-slate-500' : 'shadow-lg shadow-green-500'} rounded-[15px] bg-[#1c1c24] cursor-pointer`} onClick={handleClick}>
